...
const char* ei_classifier_inferencing_categories[] = { "help", "unknown" };

ei_dsp_named_axis_t ei_dsp_config_8_named_axes[] = {
    { .name = "Signal", .axis = 0 }
};
size_t ei_dsp_config_8_named_axes_size = 1;
EI_CLASSIFIER_DSP_AXES_INDEX_TYPE ei_dsp_config_8_axes[] = { 0 };
const uint32_t ei_dsp_config_8_axes_size = 1;
ei_dsp_config_mfcc_t ei_dsp_config_8 = {
    8, // uint32_t blockId
    4, // int implementationVersion
    1, // int length of axes
    ei_dsp_config_8_named_axes, // named axes
    ei_dsp_config_8_named_axes_size, // size of the named axes array
    13, // int num_cepstral
...
const ei_impulse_t impulse_744253_0 = {
    .project_id = 744253,
    .project_owner = "anusha3416",
    .project_name = "audio",
    .impulse_id = 1,
...
ei_impulse_handle_t impulse_handle_744253_0 = ei_impulse_handle_t( &impulse_744253_0 );
ei_impulse_handle_t& ei_default_impulse = impulse_handle_744253_0;
